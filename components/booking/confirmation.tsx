  ...
  return (
    <div className="text-center">
      ...
      <p className="text-stone-600 mb-8">
        ...
        <span className="font-medium text-amber-600">{bookingData.clientInfo?.email}</span>
      </p>

      {/* Appointment Card */}
      <div className="bg-white/90 backdrop-blur rounded-xl border border-stone-200 p-6 text-left mb-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-stone-900">KeLatic Hair Lounge</p>
        ...
        <div className="mt-6 pt-4 border-t border-stone-200">
          ...
          <div className="flex justify-between font-semibold text-stone-900 mt-2 pt-2 border-t border-stone-200">
            ...
            <span className="text-amber-600">{formatCurrency(balanceDue * 100)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        {bookingData.appointmentId ? (
          <Link
            ...
            className="block w-full py-3 bg-white border border-stone-200 text-stone-900 rounded-xl font-semibold hover:bg-stone-50 transition-colors text-center"
          >
      ...
      <div className="mt-8 bg-amber-50 border border-amber-200 rounded-xl p-4 text-left">
        <h4 className="font-semibold text-amber-700 mb-2">Before Your Appointment</h4>
