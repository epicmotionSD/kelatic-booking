...
export function Confirmation({ bookingData }: ConfirmationProps) {
  ...
  return (
    <div className="text-center">
      ...
      {/* Appointment Card */}
      <div className="bg-zinc-900 backdrop-blur rounded-xl border border-white/20 p-6 text-left mb-6">
      ...
      <div className="space-y-3">
        ...
        {bookingData.appointmentId ? (
          <Link
            ...
            className="block w-full py-3 bg-zinc-900 border border-white/20 text-white rounded-xl font-semibold hover:bg-zinc-800 transition-colors text-center"
          >
      ...
      {/* Reminders */}
      <div className="mt-8 bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 text-left">
