-- ============================================================
-- PROPOSAL (DRAFT — NOT YET APPLIED)
-- Kelatic Vitality House — Product Commerce Schema
-- ------------------------------------------------------------
-- Adds a product catalog + order/checkout layer on top of the
-- existing multi-tenant `businesses` model, and registers
-- Kelatic Vitality House as a new tenant.
--
-- Reviewed against:
--   supabase/migrations/001_initial_schema.sql   (payments, profiles)
--   supabase/migrations/010_multi_tenant.sql      (businesses, settings, members)
--
-- When approved, move/rename to:
--   supabase/migrations/050_vitality_house_commerce.sql
-- ============================================================
