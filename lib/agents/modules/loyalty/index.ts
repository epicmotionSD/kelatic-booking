...
export const loyaltyModuleManifest = {
  ...
  tools: [
    { id: 'loyalty.balance', name: 'Check balance',   endpoint: '/api/agents/loyalty/balance', method: 'GET'  },
    ...
    { id: 'loyalty.rewards', name: 'Rewards catalog', endpoint: '/api/agents/loyalty/rewards', method: 'GET'  },
    { id: 'loyalty.program', name: 'Program config',  endpoint: '/api/agents/loyalty/program', method: 'GET'  },
  ],
} as const;
