    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <button
          onClick={handleSave}
          disabled={loading}
          className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors flex items-center gap-2 w-fit disabled:opacity-50"
        >
          {loading ? (
            <>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                placeholder="contact@kelatic.com"
              />
            </div>
            ...
            {DAYS.map((day, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isClosed && (
                    <span className="text-sm text-gray-400 ml-auto">Closed</span>
                  )}
                </div>
              );
            })}
      ...
      {activeTab === 'integrations' && (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Payment processing & POS</p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">SMS & Email</h3>
                  <p className="text-sm text-gray-500">Appointment reminders & confirmations</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Sync appointments with Google</p>
                </div>
              </div>
              <span className="px-3 py-1 bg-gray-100 text-gray-500 text-sm rounded-full">
                Not Connected
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Accept bookings via DMs</p>
                </div>
              </div>
            ...
            <button disabled className="px-4 py-2 bg-gray-100 text-gray-400 rounded-lg cursor-not-allowed text-sm">
              Connect Instagram
            </button>
          </div>
        </div>
