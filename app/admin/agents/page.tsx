...
// served by GET /api/agents/orchestrator for programmatic consumers.
export default function AgentsPage() {
  const agents = listPrimaryAgents();
  const readiness = getPrimaryOrchestrator().getReadiness();
  return <AgentsBoard agents={agents} readiness={readiness} />;
}
